...
SMPP_SERVER_STATE_CLOSED = 0
SMPP_SERVER_STATE_OPEN = 1
SMPP_SERVER_STATE_BOUND_TX = 2
SMPP_SERVER_STATE_BOUND_RX = 3
SMPP_SERVER_STATE_BOUND_TRX = 4
...
SMPP_MSGMODE_STOREDELIVERY = 0x04
