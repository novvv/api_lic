...
CREATE TABLE public.transaction_log (
    transaction_log_uuid character varying(36) DEFAULT public.uuid_generate_v4() NOT NULL,
    ...
    status integer,
    result text,
    payment_uuid character varying(36),
    transaction_fee numeric DEFAULT '0'::numeric NOT NULL,
...
ALTER TABLE ONLY public.transaction_log
    ADD CONSTRAINT transaction_log_pkey PRIMARY KEY (transaction_log_uuid);
...
--
-- Name: ix_license_switch_switch_uuid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_license_switch_switch_uuid ON public.license_switch USING btree (switch_uuid);
...
--
-- Name: ix_transaction_log_payment_uuid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_transaction_log_payment_uuid ON public.transaction_log USING btree (payment_uuid);


--
-- Name: ix_transaction_log_user_uuid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_transaction_log_user_uuid ON public.transaction_log USING btree (user_uuid);
...
--
-- Name: transaction_log transaction_log_payment_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.transaction_log
    ADD CONSTRAINT transaction_log_payment_uuid_fkey FOREIGN KEY (payment_uuid) REFERENCES public.payment(payment_uuid) ON DELETE CASCADE;


--
-- Name: transaction_log transaction_log_user_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.transaction_log
    ADD CONSTRAINT transaction_log_user_uuid_fkey FOREIGN KEY (user_uuid) REFERENCES public."user"(user_uuid) ON DELETE CASCADE;
