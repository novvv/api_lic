...
class UserApi(object):
    ...
    def license_switch_license_switch_uuid_renew_patch(self, license_switch_uuid, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.license_switch_license_switch_uuid_renew_patch(license_switch_uuid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.license_switch_license_switch_uuid_renew_patch_with_http_info(license_switch_uuid, **kwargs)
        else:
            (data) = self.license_switch_license_switch_uuid_renew_patch_with_http_info(license_switch_uuid, **kwargs)
            return data
    ...
    def license_switch_license_switch_uuid_renew_patch_with_http_info(self, license_switch_uuid, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.license_switch_license_switch_uuid_renew_patch_with_http_info(license_switch_uuid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method license_switch_license_switch_uuid_renew_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'license_switch_uuid' is set
        if ('license_switch_uuid' not in params) or (params['license_switch_uuid'] is None):
            raise ValueError("Missing the required parameter `license_switch_uuid` when calling `license_switch_license_switch_uuid_renew_patch`")
        ...
        return self.api_client.call_api('/license_switch/{license_switch_uuid}/renew', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def license_switch_list_get_with_http_info(self, **kwargs):
        ...
        all_params = ['page', 'per_page', 'order_by', 'order_dir', 'amount', 'enabled', 'ip', 'license_switch_uuid', 'minute_count', 'ordered_amount', 'package_switch_uuid', 'switch_port', 'type', 'user_email', 'user_uuid', 'cost_gt', 'cost_lt', 'end_time_gt', 'end_time_lt', 'start_time_gt', 'start_time_lt']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
