...
class PublicApi(object):
    ...
    def rate_list_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.rate_list_get(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.rate_list_get_with_http_info(**kwargs)
        else:
            (data) = self.rate_list_get_with_http_info(**kwargs)
            return data

    def rate_list_get_with_http_info(self, **kwargs):
        """
        Gets rates
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.rate_list_get_with_http_info(callback=callback_function)
        ...
        all_params = ['page', 'per_page', 'order_by', 'order_dir', 'rate_uuid', 'type', 'rate_gt', 'rate_lt']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'rate_gt' in params:
            query_params.append(('rate_gt', params['rate_gt']))
        if 'rate_lt' in params:
            query_params.append(('rate_lt', params['rate_lt']))
        ...
        return self.api_client.call_api('/rate/list', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
