...
class AdminApi(object):
    ...
    def transaction_log_get_with_http_info(self, **kwargs):
        ...
        all_params = ['page', 'per_page', 'order_by', 'order_dir', 'amount_lrn', 'amount_switch', 'from_ip', 'license_lrn_plan_name', 'license_lrn_uuid', 'license_switch_plan_name', 'license_switch_uuid', 'payment_uuid', 'result', 'status', 'transaction_id', 'transaction_type', 'type', 'user_name', 'user_uuid', 'amount_total_gt', 'amount_total_lt', 'transaction_time_gt', 'transaction_time_lt']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'user_name' in params:
            query_params.append(('user_name', params['user_name']))
        if 'user_uuid' in params:
