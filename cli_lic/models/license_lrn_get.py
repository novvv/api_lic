...
class LicenseLrnGet(object):
    ...
    def __init__(self, ordered_amount=None, user_email=None, user_uuid=None, end_time=None, amount=None, start_time=None, type=None, dip_count=None, package_lrn_uuid=None, enabled=None, package=None, license_lrn_uuid=None, ip=None, cps=None, lrn_port=None):
        """
