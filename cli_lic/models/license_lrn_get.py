...
class LicenseLrnGet(object):
    ...
    def __init__(self, start_time=None, lrn_port=None, dip_count=None, enabled=None, end_time=None, license_lrn_uuid=None, user_email=None, amount=None, ip=None, user_uuid=None, package_lrn_uuid=None, duration='1 month', type=None, cps=None, package=None):
        """
