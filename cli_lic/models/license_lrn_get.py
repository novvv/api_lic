...
class LicenseLrnGet(object):
    ...
    def __init__(self, end_time=None, lrn_port=None, user_email=None, amount=None, enabled=None, start_time=None, cps=None, package=None, dip_count=None, license_lrn_uuid=None, user_uuid=None, ip=None, package_lrn_uuid=None, duration='1 month', type=None):
        """
