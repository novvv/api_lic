...
class LicenseLrnGet(object):
    ...
    def __init__(self, package=None, dip_count=None, user_uuid=None, amount=None, type=None, end_time=None, start_time=None, cps=None, enabled=None, package_lrn_uuid=None, ordered_amount=None, lrn_port=None, user_email=None, ip=None, license_lrn_uuid=None):
        """
