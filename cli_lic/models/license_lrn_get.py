...
class LicenseLrnGet(object):
    ...
    def __init__(self, ip=None, lrn_port=None, enabled=None, user_email=None, start_time=None, license_lrn_uuid=None, dip_count=None, cps=None, package_lrn_uuid=None, user_uuid=None, type=None, amount=None, package=None, ordered_amount=None, end_time=None):
        """
