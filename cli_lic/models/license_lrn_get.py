...
class LicenseLrnGet(object):
    ...
    def __init__(self, amount=None, package=None, type=None, ordered_amount=None, package_lrn_uuid=None, lrn_port=None, dip_count=None, user_email=None, end_time=None, license_lrn_uuid=None, cps=None, ip=None, start_time=None, user_uuid=None, enabled=None):
        """
