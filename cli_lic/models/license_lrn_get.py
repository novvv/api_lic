...
class LicenseLrnGet(object):
    ...
    def __init__(self, package_lrn_uuid=None, ordered_amount=None, amount=None, dip_count=None, package=None, enabled=None, user_email=None, start_time=None, license_lrn_uuid=None, lrn_port=None, cps=None, end_time=None, type=None, ip=None, user_uuid=None):
        """
