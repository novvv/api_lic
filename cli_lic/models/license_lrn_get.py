...
class LicenseLrnGet(object):
    ...
    def __init__(self, package=None, license_lrn_uuid=None, end_time=None, package_lrn_uuid=None, cps=None, amount=None, enabled=None, user_email=None, lrn_port=None, ip=None, dip_count=None, user_uuid=None, start_time=None, type=None, ordered_amount=None):
        """
