...
class LicenseLrnGet(object):
    ...
    def __init__(self, user_email=None, ordered_amount=None, end_time=None, cps=None, package=None, type=None, dip_count=None, enabled=None, lrn_port=None, package_lrn_uuid=None, ip=None, user_uuid=None, license_lrn_uuid=None, amount=None, start_time=None):
        """
