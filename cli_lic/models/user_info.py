...
class UserInfo(object):
    ...
    def __init__(self, email=None, alert_license_purchased=None, alert_payment_received=None, alert_license_will_expired=None, passwd=None, alert_license_expired=None):
        """
