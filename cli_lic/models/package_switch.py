...
class PackageSwitch(object):
    ...
    def __init__(self, start_date=None, enabled=None, amount=None, sub_type='hosted_switch', switch_port=None, minute_count=None, expire_date=None, type='switch pay per port', package_name=None):
        """
