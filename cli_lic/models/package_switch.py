...
class PackageSwitch(object):
    ...
    def __init__(self, package_name=None, switch_uuid=None, sub_type='hosted_switch', switch_port=None, type='switch pay per port', minute_count=None, enabled=None, amount=None):
        """
