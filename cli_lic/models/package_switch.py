...
class PackageSwitch(object):
    ...
    def __init__(self, expire_date=None, start_date=None, enabled=None, package_name=None, minute_count=None, type='switch pay per port', amount=None, switch_port=None, sub_type='hosted_switch'):
        """
