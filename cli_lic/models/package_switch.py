...
class PackageSwitch(object):
    ...
    def __init__(self, switch_uuid=None, sub_type='hosted_switch', amount=None, package_name=None, expire_date=None, enabled=None, switch_port=None, minute_count=None, type='switch pay per port', start_date=None):
        """
