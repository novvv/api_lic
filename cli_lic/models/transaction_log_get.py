...
class TransactionLogGet(object):
    ...
    def __init__(self, transaction_type=None, user_name=None, license_switch_uuid=None, from_ip=None, license_switch_plan_name=None, amount_switch=None, transaction_src=None, amount_lrn=None, payment_uuid=None, result=None, status=None, amount_total=None, license_lrn_uuid=None, user_uuid=None, transaction_time=None, transaction_id=None, license_lrn_plan_name=None, type=None):
        """
