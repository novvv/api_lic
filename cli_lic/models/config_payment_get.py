...
class ConfigPaymentGet(object):
    ...
    def __init__(self, paypal_email=None, paypal_test_mode=None, charge_type='actual received', stripe_svc_charge=None, confirm_enabled=None, email_cc_to=None, notification_enabled=None, paypal_pkey=None, stripe_test_mode=None, paypal_svc_charge=None, stripe_pkey=None, stripe_email=None, email_confirm_to=None):
        """
