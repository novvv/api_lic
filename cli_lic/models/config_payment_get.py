...
class ConfigPaymentGet(object):
    ...
    def __init__(self, confirm_enabled=None, stripe_email=None, notification_enabled=None, email_cc_to=None, charge_type='actual received', stripe_pkey=None, stripe_test_mode=None, stripe_svc_charge=None, email_confirm_to=None, stripe_skey=None):
        """
