...
class ConfigPaymentGet(object):
    ...
    def __init__(self, stripe_test_mode=None, notification_enabled=None, stripe_pkey=None, paypal_svc_charge=None, email_cc_to=None, paypal_test_mode=None, paypal_email=None, stripe_svc_charge=None, paypal_pkey=None, email_confirm_to=None, stripe_email=None, confirm_enabled=None, charge_type='actual received'):
        """
