...
class ConfigPaymentGet(object):
    ...
    def __init__(self, charge_type='actual received', stripe_svc_charge=None, paypal_svc_charge=None, paypal_email=None, paypal_test_mode=None, confirm_enabled=None, email_cc_to=None, stripe_pkey=None, stripe_email=None, email_confirm_to=None, stripe_test_mode=None, paypal_pkey=None, notification_enabled=None):
        """
