...
class ConfigPaymentGet(object):
    ...
    def __init__(self, paypal_client_id=None, paypal_email=None, email_confirm_to=None, stripe_test_mode=None, charge_type='actual received', notification_enabled=None, email_cc_to=None, confirm_enabled=None, stripe_svc_charge=None, stripe_pkey=None, paypal_test_mode=None, paypal_svc_charge=None):
        """
