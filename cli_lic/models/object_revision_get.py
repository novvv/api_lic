...
class ObjectRevisionGet(object):
    ...
    def __init__(self, revision_number=None, entity_pk=None, changes=None, action=None, user_id=None, id=None, restored_from_revision_id=None, revision_time=None, entity_name=None):
        """
