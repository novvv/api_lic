...
class ObjectRevisionGet(object):
    ...
    def __init__(self, id=None, user_id=None, action=None, revision_time=None, entity_name=None, revision_number=None, entity_pk=None, changes=None, restored_from_revision_id=None):
        """
