...
class ObjectRevisionGet(object):
    ...
    def __init__(self, action=None, entity_name=None, revision_number=None, revision_time=None, entity_pk=None, id=None, restored_from_revision_id=None, user_id=None, changes=None):
        """
