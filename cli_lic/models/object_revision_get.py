...
class ObjectRevisionGet(object):
    ...
    def __init__(self, revision_time=None, entity_name=None, user_id=None, changes=None, revision_number=None, action=None, entity_pk=None, id=None, restored_from_revision_id=None):
        """
