...
class ObjectRevisionGet(object):
    ...
    def __init__(self, revision_time=None, entity_name=None, action=None, id=None, revision_number=None, restored_from_revision_id=None, changes=None, entity_pk=None, user_id=None):
        """
