...
class ObjectRevisionGet(object):
    ...
    def __init__(self, changes=None, action=None, entity_name=None, user_id=None, entity_pk=None, revision_time=None, revision_number=None, id=None, restored_from_revision_id=None):
        """
