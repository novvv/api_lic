...
class ObjectRevisionGet(object):
    ...
    def __init__(self, entity_name=None, revision_number=None, restored_from_revision_id=None, id=None, entity_pk=None, action=None, user_id=None, revision_time=None, changes=None):
        """
