...
class ObjectRevisionGet(object):
    ...
    def __init__(self, entity_pk=None, action=None, entity_name=None, revision_time=None, revision_number=None, user_id=None, restored_from_revision_id=None, id=None, changes=None):
        """
