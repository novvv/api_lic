...
class ObjectRevisionGet(object):
    ...
    def __init__(self, entity_pk=None, revision_time=None, id=None, action=None, changes=None, user_id=None, restored_from_revision_id=None, entity_name=None, revision_number=None):
        """
