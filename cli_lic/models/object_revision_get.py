...
class ObjectRevisionGet(object):
    ...
    def __init__(self, revision_number=None, entity_pk=None, entity_name=None, action=None, id=None, restored_from_revision_id=None, user_id=None, revision_time=None, changes=None):
        """
