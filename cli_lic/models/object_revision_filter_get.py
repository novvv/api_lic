...
class ObjectRevisionFilterGet(object):
    ...
    def __init__(self, revision_number=None, entity_name=None, user_id=None, action=None, entity_pk=None, id=None, restored_from_revision_id=None, changes=None, revision_time=None):
        """
