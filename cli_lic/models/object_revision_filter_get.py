...
class ObjectRevisionFilterGet(object):
    ...
    def __init__(self, entity_name=None, revision_number=None, entity_pk=None, user_id=None, changes=None, id=None, revision_time=None, action=None, restored_from_revision_id=None):
        """
