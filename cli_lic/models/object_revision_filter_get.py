...
class ObjectRevisionFilterGet(object):
    ...
    def __init__(self, action=None, entity_name=None, user_id=None, revision_number=None, revision_time=None, restored_from_revision_id=None, entity_pk=None, id=None, changes=None):
        """
