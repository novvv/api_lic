...
class ObjectRevisionFilterGet(object):
    ...
    def __init__(self, entity_pk=None, action=None, changes=None, restored_from_revision_id=None, revision_time=None, revision_number=None, entity_name=None, user_id=None, id=None):
        """
