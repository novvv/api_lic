...
class ObjectRevisionFilterGet(object):
    ...
    def __init__(self, revision_time=None, revision_number=None, user_id=None, entity_name=None, restored_from_revision_id=None, entity_pk=None, action=None, changes=None, id=None):
        """
