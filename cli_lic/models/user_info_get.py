...
class UserInfoGet(object):
    ...
    def __init__(self, alert_license_expired=None, first_name=None, alert_license_purchased=None, last_login=None, user_uuid=None, alert_license_will_expired=None, logo_file_uuid=None, email=None, last_name=None, user_type=None, passwd=None, alert_payment_received=None):
        """
