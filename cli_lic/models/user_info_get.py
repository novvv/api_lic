...
class UserInfoGet(object):
    ...
    def __init__(self, passwd=None, last_login=None, alert_license_expired=None, email=None, user_type=None, alert_license_purchased=None, user_uuid=None, alert_license_will_expired=None, alert_payment_received=None):
        """
