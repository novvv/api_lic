...
class UserInfoGet(object):
    ...
    def __init__(self, logo_file_uuid=None, user_type=None, last_login=None, alert_payment_received=None, email=None, alert_license_will_expired=None, alert_license_purchased=None, last_name=None, passwd=None, alert_license_expired=None, first_name=None, user_uuid=None):
        """
