...
class UserInfoGet(object):
    ...
    def __init__(self, user_type=None, alert_license_expired=None, user_uuid=None, passwd=None, alert_license_will_expired=None, email=None, last_login=None, alert_payment_received=None, alert_license_purchased=None):
        """
