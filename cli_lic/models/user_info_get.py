...
class UserInfoGet(object):
    ...
    def __init__(self, alert_payment_received=None, first_name=None, alert_license_purchased=None, email=None, alert_license_expired=None, logo_file_uuid=None, last_login=None, alert_license_will_expired=None, last_name=None, passwd=None, user_uuid=None, user_type=None):
        """
