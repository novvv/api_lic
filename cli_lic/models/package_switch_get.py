...
class PackageSwitchGet(object):
    ...
    def __init__(self, type='switch pay per port', package_name=None, expire_date=None, enabled=None, sub_type='hosted_switch', switch_uuid=None, minute_count=None, package_switch_uuid=None, amount=None, start_date=None, switch_port=None):
        """
