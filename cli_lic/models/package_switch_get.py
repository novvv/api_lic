...
class PackageSwitchGet(object):
    ...
    def __init__(self, switch_uuid=None, sub_type='hosted_switch', amount=None, package_name=None, expire_date=None, enabled=None, switch_port=None, type='switch pay per port', minute_count=None, package_switch_uuid=None, start_date=None):
        """
