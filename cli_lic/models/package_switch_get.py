...
class PackageSwitchGet(object):
    ...
    def __init__(self, switch_port=None, minute_count=None, amount=None, expire_date=None, switch_uuid=None, type='switch pay per port', start_date=None, package_switch_uuid=None, sub_type='hosted_switch', package_name=None, enabled=None):
        """
