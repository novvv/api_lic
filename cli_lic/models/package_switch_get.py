...
class PackageSwitchGet(object):
    ...
    def __init__(self, package_switch_uuid=None, minute_count=None, switch_uuid=None, switch_port=None, package_name=None, type='switch pay per port', amount=None, enabled=None):
        """
