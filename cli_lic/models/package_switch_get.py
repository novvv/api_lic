...
class PackageSwitchGet(object):
    ...
    def __init__(self, package_name=None, package_switch_uuid=None, enabled=None, minute_count=None, switch_uuid=None, amount=None, type='switch pay per port', switch_port=None):
        """
