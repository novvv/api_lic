...
class PackageSwitchGet(object):
    ...
    def __init__(self, enabled=None, switch_port=None, package_name=None, amount=None, sub_type='hosted_switch', start_date=None, minute_count=None, type='switch pay per port', switch_uuid=None, expire_date=None, package_switch_uuid=None):
        """
