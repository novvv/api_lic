...
class PackageSwitchGet(object):
    ...
    def __init__(self, package_name=None, start_date=None, enabled=None, package_switch_uuid=None, expire_date=None, minute_count=None, type='switch pay per port', amount=None, switch_port=None, sub_type='hosted_switch', create_on=None):
        """
