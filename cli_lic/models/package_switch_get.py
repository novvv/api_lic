...
class PackageSwitchGet(object):
    ...
    def __init__(self, amount=None, package_switch_uuid=None, switch_uuid=None, enabled=None, switch_port=None, package_name=None, minute_count=None, type='switch pay per port'):
        """
