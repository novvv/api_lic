...
class PackageSwitchGet(object):
    ...
    def __init__(self, package_name=None, minute_count=None, switch_port=None, sub_type='hosted_switch', amount=None, expire_date=None, enabled=None, start_date=None, package_switch_uuid=None, create_on=None, type='switch pay per port'):
        """
