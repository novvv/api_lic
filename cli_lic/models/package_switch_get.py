...
class PackageSwitchGet(object):
    ...
    def __init__(self, package_name=None, switch_ip=None, enabled=None, switch_port=None, package_switch_uuid=None, type='switch pay per port', amount=None, minute_count=None):
        """
