...
class PackageSwitchGet(object):
    ...
    def __init__(self, package_switch_uuid=None, enabled=None, create_on=None, amount=None, sub_type='hosted_switch', switch_port=None, minute_count=None, expire_date=None, start_date=None, type='switch pay per port', package_name=None):
        """
