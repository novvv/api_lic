...
class PackageSwitchGet(object):
    ...
    def __init__(self, amount=None, minute_count=None, package_name=None, type='switch pay per port', enabled=None, switch_uuid=None, package_switch_uuid=None, switch_port=None):
        """
