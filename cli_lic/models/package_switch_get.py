...
class PackageSwitchGet(object):
    ...
    def __init__(self, enabled=None, amount=None, expire_date=None, start_date=None, minute_count=None, switch_uuid=None, create_on=None, package_name=None, package_switch_uuid=None, switch_port=None, type='switch pay per port', switch_ip=None, sub_type='hosted_switch'):
        """
