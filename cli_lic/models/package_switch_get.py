...
class PackageSwitchGet(object):
    ...
    def __init__(self, amount=None, switch_uuid=None, enabled=None, package_name=None, type='switch pay per port', minute_count=None, package_switch_uuid=None, switch_port=None):
        """
