...
class PackageSwitchGet(object):
    ...
    def __init__(self, start_date=None, enabled=None, package_switch_uuid=None, switch_port=None, package_name=None, switch_uuid=None, minute_count=None, expire_date=None, sub_type='hosted_switch', amount=None, type='switch pay per port'):
        """
