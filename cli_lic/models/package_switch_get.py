...
class PackageSwitchGet(object):
    ...
    def __init__(self, start_date=None, amount=None, type='switch pay per port', sub_type='hosted_switch', package_switch_uuid=None, switch_port=None, enabled=None, expire_date=None, minute_count=None, package_name=None, create_on=None, switch_uuid=None):
        """
