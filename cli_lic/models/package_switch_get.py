...
class PackageSwitchGet(object):
    ...
    def __init__(self, switch_uuid=None, sub_type='hosted_switch', switch_port=None, expire_date=None, enabled=None, start_date=None, amount=None, package_switch_uuid=None, package_name=None, type='switch pay per port', minute_count=None):
        """
