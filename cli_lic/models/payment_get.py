...
class PaymentGet(object):
    ...
    def __init__(self, license_switch_uuid=None, user_uuid=None, license_lrn_uuid=None, amount_switch=None, type='paypal', amount_total=None, amount_lrn=None, paid_time=None, switch_uuid=None, payment_uuid=None):
        """
