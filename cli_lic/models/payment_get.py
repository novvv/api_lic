...
class PaymentGet(object):
    ...
    def __init__(self, user_email=None, amount_lrn=None, amount_switch=None, payment_uuid=None, description=None, license_lrn_uuid=None, switch_package_name=None, switch_uuid=None, lrn_package_name=None, paid_time=None, user_uuid=None, type='paypal', license_switch_uuid=None, amount_total=None):
        """
