...
class PaymentGet(object):
    ...
    def __init__(self, payment_uuid=None, amount_switch=None, user_uuid=None, type='paypal', paid_time=None, license_switch_uuid=None, switch_uuid=None, license_lrn_uuid=None, amount_lrn=None, amount_total=None):
        """
