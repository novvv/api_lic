...
class PaymentGet(object):
    ...
    def __init__(self, user_email=None, description=None, amount_switch=None, license_switch_uuid=None, paid_time=None, amount_lrn=None, switch_uuid=None, amount_total=None, license_lrn_uuid=None, user_uuid=None, lrn_package_name=None, switch_package_name=None, payment_uuid=None, type='paypal'):
        """
