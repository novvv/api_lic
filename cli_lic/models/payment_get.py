...
class PaymentGet(object):
    ...
    def __init__(self, license_lrn_uuid=None, paid_time=None, amount_lrn=None, license_switch_uuid=None, payment_uuid=None, amount_total=None, switch_uuid=None, amount_switch=None, user_uuid=None, type='paypal'):
        """
