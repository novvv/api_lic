...
class PaymentGet(object):
    ...
    def __init__(self, user_uuid=None, license_lrn_uuid=None, license_switch_uuid=None, paid_time=None, amount_switch=None, payment_uuid=None, amount_lrn=None, switch_uuid=None, type='paypal', amount_total=None):
        """
