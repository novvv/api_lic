...
class PaymentGet(object):
    ...
    def __init__(self, switch_uuid=None, user_uuid=None, license_lrn_uuid=None, amount_lrn=None, license_switch_uuid=None, payment_uuid=None, paid_time=None, type='paypal', amount_switch=None, amount_total=None):
        """
