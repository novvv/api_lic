...
class PaymentGet(object):
    ...
    def __init__(self, amount_switch=None, switch_uuid=None, type='paypal', license_lrn_uuid=None, paid_time=None, amount_total=None, license_switch_uuid=None, payment_uuid=None, user_uuid=None, amount_lrn=None):
        """
