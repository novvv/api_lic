...
class PaymentGet(object):
    ...
    def __init__(self, paid_time=None, license_switch_uuid=None, user_uuid=None, type='paypal', payment_uuid=None, switch_uuid=None, license_lrn_uuid=None, amount_lrn=None, description=None, amount_switch=None, lrn_package_name=None, user_email=None, switch_package_name=None, amount_total=None):
        """
