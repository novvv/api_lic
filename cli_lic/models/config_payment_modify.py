...
class ConfigPaymentModify(object):
    ...
    def __init__(self, stripe_email=None, charge_type='actual received', stripe_svc_charge=None, paypal_test_mode=None, paypal_email=None, stripe_skey=None, notification_enabled=None, paypal_pkey=None, email_confirm_to=None, confirm_enabled=None, stripe_pkey=None, email_cc_to=None, paypal_svc_charge=None, stripe_test_mode=None, paypal_skey=None):
        """
