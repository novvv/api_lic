...
class ConfigPaymentModify(object):
    ...
    def __init__(self, email_confirm_to=None, confirm_enabled=None, stripe_test_mode=None, charge_type='actual received', stripe_svc_charge=None, paypal_test_mode=None, stripe_email=None, email_cc_to=None, stripe_skey=None, paypal_skey=None, paypal_pkey=None, paypal_email=None, stripe_pkey=None, paypal_svc_charge=None, notification_enabled=None):
        """
