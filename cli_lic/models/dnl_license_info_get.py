...
class DnlLicenseInfoGet(object):
    ...
    def __init__(self, ss_type=None, expire_date=None, create_user=None, ss_bind_ip=None, max_cps=None, status=None, carrier_name=None, expires=None, port_limit=None, ss_bind_mac=None, switch_ip=None, start_date=None, recv_port=None, switch_uuid=None, plan_name=None, ss_bind_port=None, ss_name=None, id=None):
        """
