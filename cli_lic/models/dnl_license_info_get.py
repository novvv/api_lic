...
class DnlLicenseInfoGet(object):
    ...
    def __init__(self, recv_port=None, ss_bind_port=None, start_date=None, ss_type=None, ss_name=None, port_limit=None, carrier_name=None, expire_date=None, switch_uuid=None, status=None, create_user=None, plan_name=None, expires=None, ss_bind_ip=None, ss_bind_mac=None, id=None, max_cps=None, switch_ip=None):
        """
