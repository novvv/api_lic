...
class DnlLicenseInfoGet(object):
    ...
    def __init__(self, port_limit=None, switch_ip=None, ss_type=None, expires=None, recv_port=None, plan_name=None, max_cps=None, create_user=None, ss_bind_port=None, switch_uuid=None, start_date=None, status=None, carrier_name=None, ss_bind_ip=None, ss_name=None, ss_bind_mac=None, expire_date=None, id=None):
        """
