...
class UserGet(object):
    ...
    def __init__(self, email=None, is_admin=None, created_on=None, passwd=None, logo_file_uuid=None, is_active=None, user_uuid=None, last_login=None, role_name=None):
        """
