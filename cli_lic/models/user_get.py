...
class UserGet(object):
    ...
    def __init__(self, logo_file_uuid=None, last_login=None, user_uuid=None, passwd=None, created_on=None, email=None, is_active=None, is_admin=None, role_name=None):
        """
