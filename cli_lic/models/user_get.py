...
class UserGet(object):
    ...
    def __init__(self, role_name=None, logo_file_uuid=None, created_on=None, is_admin=None, passwd=None, email=None, user_uuid=None, is_active=None, last_login=None):
        """
