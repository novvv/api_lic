...
class UserGet(object):
    ...
    def __init__(self, is_active=None, role_name=None, user_uuid=None, last_login=None, email=None, is_admin=None, logo_file_uuid=None, passwd=None, created_on=None):
        """
