...
class UserGet(object):
    ...
    def __init__(self, passwd=None, last_login=None, is_active=None, logo_file_uuid=None, created_on=None, email=None, role_name=None, user_uuid=None, is_admin=None):
        """
