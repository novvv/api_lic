...
class UserGet(object):
    ...
    def __init__(self, created_on=None, passwd=None, role_name=None, logo_file_uuid=None, user_uuid=None, is_active=None, last_login=None, email=None, is_admin=None):
        """
