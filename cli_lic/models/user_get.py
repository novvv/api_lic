...
class UserGet(object):
    ...
    def __init__(self, passwd=None, logo_file_uuid=None, email=None, role_name=None, is_admin=None, created_on=None, user_uuid=None, last_login=None, is_active=None):
        """
