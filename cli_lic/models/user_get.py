...
class UserGet(object):
    ...
    def __init__(self, role_name=None, email=None, last_login=None, created_on=None, user_uuid=None, passwd=None, is_admin=None, is_active=None, logo_file_uuid=None):
        """
