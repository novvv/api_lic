...
class UserGet(object):
    ...
    def __init__(self, passwd=None, email=None, user_uuid=None, role_name=None, logo_file_uuid=None, created_on=None, last_login=None, is_admin=None, is_active=None):
        """
