...
class UserGet(object):
    ...
    def __init__(self, email=None, created_on=None, user_uuid=None, logo_file_uuid=None, last_login=None, is_admin=None, passwd=None, role_name=None, is_active=None):
        """
