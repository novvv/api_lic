...
class UserGet(object):
    ...
    def __init__(self, role_name=None, last_login=None, created_on=None, passwd=None, is_admin=None, user_uuid=None, is_active=None, email=None, logo_file_uuid=None):
        """
