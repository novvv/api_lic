...
class UserGet(object):
    ...
    def __init__(self, last_login=None, is_active=None, role_name=None, is_admin=None, created_on=None, logo_file_uuid=None, user_uuid=None, email=None, passwd=None):
        """
