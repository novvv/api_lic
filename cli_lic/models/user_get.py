...
class UserGet(object):
    ...
    def __init__(self, is_active=None, role_name=None, passwd=None, last_login=None, email=None, user_uuid=None, logo_file_uuid=None, is_admin=None, created_on=None):
        """
