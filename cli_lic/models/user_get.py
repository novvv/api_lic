...
class UserGet(object):
    ...
    def __init__(self, last_login=None, email=None, is_active=None, user_uuid=None, created_on=None, passwd=None, logo_file_uuid=None, is_admin=None, role_name=None):
        """
