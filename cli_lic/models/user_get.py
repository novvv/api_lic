...
class UserGet(object):
    ...
    def __init__(self, email=None, is_admin=None, user_uuid=None, logo_file_uuid=None, is_active=None, last_login=None, passwd=None, created_on=None, role_name=None):
        """
