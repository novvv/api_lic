...
class UserGet(object):
    ...
    def __init__(self, passwd=None, role_name=None, created_on=None, email=None, user_uuid=None, logo_file_uuid=None, is_active=None, last_login=None, is_admin=None):
        """
