...
class UserGet(object):
    ...
    def __init__(self, created_on=None, logo_file_uuid=None, is_admin=None, is_active=None, user_uuid=None, passwd=None, email=None, last_login=None, role_name=None):
        """
