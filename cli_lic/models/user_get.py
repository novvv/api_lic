...
class UserGet(object):
    ...
    def __init__(self, user_uuid=None, logo_file_uuid=None, role_name=None, is_admin=None, email=None, is_active=None, created_on=None, last_login=None, passwd=None):
        """
