...
class UserGet(object):
    ...
    def __init__(self, is_admin=None, user_uuid=None, passwd=None, role_name=None, email=None, last_login=None, is_active=None, logo_file_uuid=None, created_on=None):
        """
