...
class UserGet(object):
    ...
    def __init__(self, user_uuid=None, is_admin=None, created_on=None, is_active=None, passwd=None, last_login=None, role_name=None, email=None, logo_file_uuid=None):
        """
