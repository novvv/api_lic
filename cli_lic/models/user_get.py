...
class UserGet(object):
    ...
    def __init__(self, role_name=None, last_login=None, email=None, created_on=None, logo_file_uuid=None, passwd=None, is_admin=None, is_active=None, user_uuid=None):
        """
