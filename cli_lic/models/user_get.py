...
class UserGet(object):
    ...
    def __init__(self, logo_file_uuid=None, user_uuid=None, role_name=None, created_on=None, last_login=None, is_active=None, email=None, passwd=None, is_admin=None):
        """
