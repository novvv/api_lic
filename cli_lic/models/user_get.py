...
class UserGet(object):
    ...
    def __init__(self, created_on=None, passwd=None, last_login=None, role_name=None, is_active=None, email=None, logo_file_uuid=None, user_uuid=None, is_admin=None):
        """
