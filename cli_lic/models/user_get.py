...
class UserGet(object):
    ...
    def __init__(self, email=None, logo_file_uuid=None, created_on=None, passwd=None, is_admin=None, last_login=None, role_name=None, user_uuid=None, is_active=None):
        """
