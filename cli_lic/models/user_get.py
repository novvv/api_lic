...
class UserGet(object):
    ...
    def __init__(self, user_uuid=None, role_name=None, created_on=None, last_login=None, passwd=None, email=None, is_active=None, is_admin=None, logo_file_uuid=None):
        """
