...
class UserInfoModify(object):
    ...
    def __init__(self, alert_license_purchased=None, alert_license_expired=None, passwd=None, first_name=None, last_name=None, logo_file_uuid=None, alert_license_will_expired=None, email=None, alert_payment_received=None):
        """
