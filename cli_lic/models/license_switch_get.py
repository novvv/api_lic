...
class LicenseSwitchGet(object):
    ...
    def __init__(self, package=None, user_uuid=None, amount=None, type=None, end_time=None, package_switch_uuid=None, switch_port=None, enabled=None, ordered_amount=None, license_switch_uuid=None, start_time=None, minute_count=None, user_email=None, ip=None):
        """
