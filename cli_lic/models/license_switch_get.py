...
class LicenseSwitchGet(object):
    ...
    def __init__(self, start_time=None, license_switch_uuid=None, type=None, switch_port=None, enabled=None, minute_count=None, user_uuid=None, package_switch_uuid=None, package=None, ordered_amount=None, end_time=None, ip=None, amount=None, user_email=None):
        """
