...
class LicenseSwitchGet(object):
    ...
    def __init__(self, ordered_amount=None, amount=None, package=None, enabled=None, user_uuid=None, user_email=None, start_time=None, license_switch_uuid=None, switch_port=None, minute_count=None, ip=None, type=None, package_switch_uuid=None, end_time=None):
        """
