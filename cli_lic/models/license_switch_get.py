...
class LicenseSwitchGet(object):
    ...
    def __init__(self, enabled=None, user_uuid=None, ordered_amount=None, end_time=None, start_time=None, minute_count=None, package=None, amount=None, type=None, package_switch_uuid=None, license_switch_uuid=None, user_email=None, ip=None, switch_port=None):
        """
