...
class LicenseSwitchGet(object):
    ...
    def __init__(self, package_switch_uuid=None, amount=None, switch_port=None, minute_count=None, type=None, user_uuid=None, plan_uuid=None, ip=None, package=None, license_switch_uuid=None, ordered_amount=None, user_email=None):
        """
