...
class LicenseSwitchGet(object):
    ...
    def __init__(self, type=None, license_switch_uuid=None, package=None, enabled=None, user_email=None, amount=None, user_uuid=None, ordered_amount=None, end_time=None, minute_count=None, package_switch_uuid=None, ip=None, start_time=None, switch_port=None):
        """
