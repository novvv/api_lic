...
class LicenseSwitchGet(object):
    ...
    def __init__(self, switch_port=None, amount=None, package=None, type=None, ordered_amount=None, package_switch_uuid=None, license_switch_uuid=None, ip=None, minute_count=None, user_email=None, start_time=None, user_uuid=None, end_time=None, enabled=None):
        """
