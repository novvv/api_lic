...
class LicenseSwitchGet(object):
    ...
    def __init__(self, enabled=None, user_email=None, amount=None, end_time=None, license_switch_uuid=None, switch_port=None, start_time=None, duration='1 month', package=None, switch_uuid=None, package_switch_uuid=None, user_uuid=None, ip=None, minute_count=None, ordered_amount=None, type=None):
        """
