...
class LicenseSwitchGet(object):
    ...
    def __init__(self, user_email=None, package=None, start_time=None, package_switch_uuid=None, ordered_amount=None, minute_count=None, user_uuid=None, end_time=None, amount=None, ip=None, switch_uuid=None, enabled=None, type=None, duration='1 month', switch_port=None, license_switch_uuid=None):
        """
