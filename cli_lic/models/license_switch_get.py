...
class LicenseSwitchGet(object):
    ...
    def __init__(self, ip=None, license_switch_uuid=None, enabled=None, user_email=None, start_time=None, minute_count=None, switch_port=None, end_time=None, user_uuid=None, type=None, amount=None, package=None, package_switch_uuid=None, ordered_amount=None):
        """
