...
class LicenseSwitchGet(object):
    ...
    def __init__(self, amount=None, license_switch_uuid=None, type=None, start_time=None, switch_port=None, user_uuid=None, package=None, end_time=None, user_email=None, enabled=None, minute_count=None, ip=None, ordered_amount=None, package_switch_uuid=None):
        """
