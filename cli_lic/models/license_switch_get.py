...
class LicenseSwitchGet(object):
    ...
    def __init__(self, user_email=None, ordered_amount=None, license_switch_uuid=None, minute_count=None, package=None, type=None, switch_port=None, enabled=None, ip=None, user_uuid=None, end_time=None, amount=None, start_time=None, package_switch_uuid=None):
        """
