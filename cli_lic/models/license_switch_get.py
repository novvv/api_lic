...
class LicenseSwitchGet(object):
    ...
    def __init__(self, enabled=None, amount=None, user_uuid=None, package=None, end_time=None, minute_count=None, ip=None, ordered_amount=None, package_switch_uuid=None, user_email=None, license_switch_uuid=None, switch_port=None, start_time=None, type=None):
        """
