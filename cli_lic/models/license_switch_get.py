...
class LicenseSwitchGet(object):
    ...
    def __init__(self, end_time=None, user_uuid=None, switch_port=None, package=None, ordered_amount=None, enabled=None, package_switch_uuid=None, minute_count=None, license_switch_uuid=None, ip=None, start_time=None, type=None, amount=None, user_email=None):
        """
