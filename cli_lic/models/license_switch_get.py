...
class LicenseSwitchGet(object):
    ...
    def __init__(self, package=None, minute_count=None, end_time=None, amount=None, enabled=None, package_switch_uuid=None, user_email=None, switch_port=None, ip=None, license_switch_uuid=None, user_uuid=None, start_time=None, type=None, ordered_amount=None):
        """
