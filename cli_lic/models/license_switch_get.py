...
class LicenseSwitchGet(object):
    ...
    def __init__(self, amount=None, license_switch_uuid=None, package=None, user_email=None, switch_port=None, ip=None, end_time=None, minute_count=None, ordered_amount=None, package_switch_uuid=None, enabled=None, start_time=None, user_uuid=None, type=None):
        """
