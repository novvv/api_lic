...
class DnlLicenseInfoModify(object):
    ...
    def __init__(self, ss_type=None, update_time=None, recv_ip=None, start_time=None, ss_bind_ip=None, max_cps=None, status=None, create_time=None, carrier_name=None, expires=None, uuid=None, ss_bind_mac=None, max_cap=None, create_user=None, end_time=None, recv_port=None, ss_bind_port=None, ss_name=None):
        """
