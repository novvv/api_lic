...
class DnlLicenseInfoModify(object):
    ...
    def __init__(self, recv_port=None, ss_bind_port=None, create_time=None, start_time=None, ss_type=None, ss_name=None, carrier_name=None, end_time=None, max_cap=None, status=None, create_user=None, recv_ip=None, uuid=None, expires=None, ss_bind_ip=None, ss_bind_mac=None, update_time=None, max_cps=None):
        """
