...
class DnlLicenseInfoModify(object):
    ...
    def __init__(self, ss_bind_port=None, max_cps=None, ss_type=None, uuid=None, create_user=None, ss_name=None, recv_ip=None, end_time=None, create_time=None, ss_bind_mac=None, carrier_name=None, ss_bind_ip=None, recv_port=None, status=None, expires=None, update_time=None, max_cap=None, start_time=None):
        """
