...
class DnlLicenseInfoModify(object):
    ...
    def __init__(self, ss_name=None, expires=None, ss_bind_port=None, carrier_name=None, create_time=None, ss_type=None, max_cps=None, create_user=None, update_time=None, recv_port=None, uuid=None, recv_ip=None, end_time=None, ss_bind_mac=None, max_cap=None, start_time=None, status=None, ss_bind_ip=None):
        """
