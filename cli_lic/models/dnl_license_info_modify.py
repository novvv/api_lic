...
class DnlLicenseInfoModify(object):
    ...
    def __init__(self, uuid=None, create_time=None, ss_name=None, ss_bind_ip=None, expires=None, create_user=None, status=None, carrier_name=None, ss_type=None, start_time=None, max_cps=None, max_cap=None, update_time=None, recv_ip=None, ss_bind_port=None, recv_port=None, ss_bind_mac=None, end_time=None):
        """
