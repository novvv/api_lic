...
class DnlLicenseInfoModify(object):
    ...
    def __init__(self, end_time=None, expires=None, max_cap=None, ss_bind_ip=None, uuid=None, ss_bind_port=None, ss_type=None, ss_name=None, max_cps=None, carrier_name=None, status=None, update_time=None, recv_ip=None, create_user=None, ss_bind_mac=None, create_time=None, recv_port=None, start_time=None):
        """
