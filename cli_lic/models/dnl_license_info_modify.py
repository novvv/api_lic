...
class DnlLicenseInfoModify(object):
    ...
    def __init__(self, end_time=None, start_time=None, ss_type=None, expires=None, max_cap=None, recv_port=None, ss_name=None, update_time=None, max_cps=None, ss_bind_port=None, ss_bind_mac=None, status=None, ss_bind_ip=None, carrier_name=None, uuid=None, create_time=None, recv_ip=None, create_user=None):
        """
