...
class DnlLicenseInfoModify(object):
    ...
    def __init__(self, ss_type=None, ss_bind_ip=None, create_time=None, status=None, update_time=None, start_time=None, expires=None, ss_bind_port=None, recv_port=None, uuid=None, recv_ip=None, create_user=None, max_cps=None, ss_name=None, max_cap=None, ss_bind_mac=None, carrier_name=None, end_time=None):
        """
