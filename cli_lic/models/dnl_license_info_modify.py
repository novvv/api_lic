...
class DnlLicenseInfoModify(object):
    ...
    def __init__(self, ss_type=None, ss_name=None, carrier_name=None, end_time=None, update_time=None, status=None, start_time=None, create_time=None, ss_bind_ip=None, max_cps=None, create_user=None, ss_bind_mac=None, uuid=None, ss_bind_port=None, recv_ip=None, max_cap=None, expires=None, recv_port=None):
        """
