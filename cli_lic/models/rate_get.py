...
class RateGet(object):
    ...
    def type(self):
        """
        Gets the type of this RateGet.

        :return: The type of this RateGet.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this RateGet.

        :param type: The type of this RateGet.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RateGet):
            return False
