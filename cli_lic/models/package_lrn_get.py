...
class PackageLrnGet(object):
    ...
    def __init__(self, enabled=None, cps=None, package_lrn_uuid=None, type='LRN pay per CPS', dip_count=None, lrn_port=None, package_name=None, amount=None, create_on=None):
        """
