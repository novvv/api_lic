...
class PackageLrnGet(object):
    ...
    def __init__(self, cps=None, enabled=None, package_lrn_uuid=None, dip_count=None, amount=None, type='LRN pay per CPS', lrn_port=None, create_on=None, package_name=None):
        """
