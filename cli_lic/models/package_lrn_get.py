...
class PackageLrnGet(object):
    ...
    def __init__(self, enabled=None, amount=None, cps=None, dip_count=None, package_lrn_uuid=None, create_on=None, package_name=None, type='LRN pay per CPS', lrn_port=None):
        """
