...
class PackageLrnGet(object):
    ...
    def __init__(self, package_name=None, lrn_port=None, dip_count=None, enabled=None, package_lrn_uuid=None, amount=None, create_on=None, cps=None, type='LRN pay per CPS'):
        """
