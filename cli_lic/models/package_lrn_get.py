...
class PackageLrnGet(object):
    ...
    def __init__(self, enabled=None, lrn_port=None, create_on=None, amount=None, package_lrn_uuid=None, dip_count=None, cps=None, type='LRN pay per CPS', package_name=None):
        """
