...
class PackageLrnGet(object):
    ...
    def __init__(self, lrn_port=None, enabled=None, package_name=None, cps=None, type='LRN pay per CPS', amount=None, dip_count=None, package_lrn_uuid=None, create_on=None):
        """
