...
class PackageLrnGet(object):
    ...
    def __init__(self, lrn_port=None, dip_count=None, package_lrn_uuid=None, cps=None, amount=None, create_on=None, enabled=None, type='LRN pay per CPS', package_name=None):
        """
