...
class PackageLrnGet(object):
    ...
    def __init__(self, type='LRN pay per CPS', enabled=None, dip_count=None, amount=None, package_name=None, create_on=None, cps=None, lrn_port=None, package_lrn_uuid=None):
        """
