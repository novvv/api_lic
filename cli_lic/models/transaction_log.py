...
class TransactionLog(object):
    ...
    def __init__(self, amount_lrn=None, amount_switch=None, result=None, payment_uuid=None, transaction_time=None, license_lrn_uuid=None, status=None, transaction_src=None, transaction_id=None, from_ip=None, type=None, license_switch_uuid=None, amount_total=None, transaction_type=None):
        """
