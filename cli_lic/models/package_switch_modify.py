...
class PackageSwitchModify(object):
    ...
    def __init__(self, switch_port=None, minute_count=None, amount=None, expire_date=None, switch_uuid=None, type='switch pay per port', start_date=None, sub_type='hosted_switch', package_name=None, enabled=None):
        """
