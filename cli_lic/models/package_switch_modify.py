...
class PackageSwitchModify(object):
    ...
    def __init__(self, switch_port=None, package_name=None, sub_type='hosted_switch', enabled=None, amount=None, expire_date=None, type='switch pay per port', start_date=None, switch_uuid=None, minute_count=None):
        """
