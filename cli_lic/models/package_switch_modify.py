...
class PackageSwitchModify(object):
    ...
    def __init__(self, expire_date=None, type='switch pay per port', package_name=None, minute_count=None, enabled=None, start_date=None, sub_type='hosted_switch', switch_port=None, amount=None):
        """
